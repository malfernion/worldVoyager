...
export const PARTS = {
  ...
  garage: { name: 'Garage', slot: 'stack', mass: 0.8, height: 2.4, garage: true, paint: 'wood' },
};
...
/** The garage part of a design (if any). */
export function garageOf(design) {
  return design.stack.find((p) => p.type === 'garage') || null;
}
